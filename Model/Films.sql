...
insert into Films (name, director, duration, trailer_url, description, age) values ('Inception', 'Christopher Nolan', '2:28', 'YoHD9XEInc0','A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O., but his tragic past may doom the project and his team to disaster.', '12A');
insert into Films (name, director, duration, trailer_url, description,  age) values ('Avatar: The Way of the Water', 'James Cameron', '3:13', 'd9MyW72ELq0',"Jake Sully lives with his newfound family formed on the extrasolar moon Pandora. Once a familiar threat returns to finish what was previously started, Jake must work with Neytiri and the army of the Na'vi race to protect their home.",'PG');
insert into Films (name, director, duration, trailer_url, description, age) values ('The Fabelmans', 'Steven Spielberg', '2:31', 'D1G2iLSzOe8',"Growing up in post-World War II era Arizona, young Sammy Fabelman aspires to become a filmmaker as he reaches adolescence, but soon discovers a shattering family secret and explores how the power of films can help him see the truth.",'18');
insert into Films (name, director, duration, trailer_url, description, age) values ('Puss in Boots: The Last Wish', 'Joel Crawford', '1:42', 'RqrXhwS33yc',"When Puss in Boots discovers that his passion for adventure has taken its toll and he has burned through eight of his nine lives, he launches an epic journey to restore them by finding the mythical Last Wish.",'U');
insert into Films (name, director, duration, trailer_url, description, age) values ('Babylon', 'Damien Chazelle', '3:09', '5muQK7CuFtY',"A tale of outsized ambition and outrageous excess, it traces the rise and fall of multiple characters during an era of unbridled decadence and depravity in early Hollywood.",'18');
insert into Films (name, director, duration, trailer_url, description, age) values ('Life is a Jungle', 'Robert D. Hanna', '1:41', 'rwyUzHEG_XY',"When Pip, a pampered and snobbish puppy, gets separated from his owners on an African safari, he is forced to adapt a new way of life in the jungle where he learns that caviar and manicures can never bring the same happiness as friendship.",'U');
insert into Films (name, director, duration, trailer_url, description, age) values ('Guardians of the Galaxy Vol. 3', 'James Gunn', '2:22', 'u3V5KDHRQvk',"Still reeling from the loss of Gamora, Peter Quill rallies his team to defend the universe and one of their own - a mission that could mean the end of the Guardians if not successful.",'12A');
insert into Films (name, director, duration, trailer_url, description, age) values ('Ant-Man and The Wasp: Quantumania', 'Peyton Reed', '2:05', 'ZlNFpri-Y40',"Scott Lang and Hope Van Dyne, along with Hank Pym and Janet Van Dyne, explore the Quantum Realm, where they interact with strange creatures and embark on an adventure that goes beyond the limits of what they thought was possible.",'12A');
insert into Films (name, director, duration, trailer_url, description, age) values ('Spider-Man Across the Spiderverse', 'Joaqium Dos Santos', '1:54', 'cqGjhVJWtEg',"Miles Morales catapults across the Multiverse, where he encounters a team of Spider-People charged with protecting its very existence. When the heroes clash on how to handle a new threat, Miles must redefine what it means to be a hero.",'U');
